...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('badger_badge', 'criteria', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Badge.criteria'
        db.delete_column('badger_badge', 'criteria')
