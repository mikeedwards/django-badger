...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Badge.points'
        db.alter_column('badger_badge', 'points', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Badge.points'
        db.alter_column('badger_badge', 'points', self.gf('django.db.models.fields.IntegerField')(default=0))
